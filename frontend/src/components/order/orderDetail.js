      ...
      if(this.props.detailedOrder){
          ...
          orderDetailsHeader=
              <Grid columns={3} id="orderdetailHeader">
                  ...
                  <Grid.Row>
                      <Grid.Column width={8} style={{"padding-top":"10px"}}><h4>Ordered on {this.props.detailedOrder.orderDate.split('T')[0]} <span>|</span>   Order# {this.props.detailedOrder.orderId}</h4></Grid.Column>
