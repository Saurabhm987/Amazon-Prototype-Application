...
handle_request = async (request, callback) => {
    if (request.type === "getProductAnalytics") {  
        try {
            let results = {
    ...
    else if (request.type === "getSalesAnalytics") {
        try {
            let results = {
    ...
    else if (request.type === "getSellerStatistics") {
        try{
    ...
    else if (request.type === "getSellerMonthlyStatistics") {
        try{
            let resp = await order.aggregate([
                { "$match": { sellerId: ObjectID(request.user.userId) } },
                {
    ...
    else if (request.type === "getSellerMonthlyStatisticsById") {
        try{
            let resp = await order.aggregate([
...
getTopTenProductsRating = async (req) => {
    try {
...
getTopTenViewedPerDay = async (req) => {
    try {
...
getCountOrdersPerDay = async (req) => {
...
getTopFiveMostSoldProducts = async (req) => {
    try {
...
// exports.getTopFiveSellersAmount = async (req) => {
 getTopFiveSellersAmount = async (req) => {
...
getTopFiveCustomerAmount = async (req) => {
...
//     }
//     else if (request.type === "addCart") {
        
//     }
//     else if (request.type === "deleteCart") {

//     }
//     else if (request.type === "updateCart") {
        
//     }

//     else if (request.type === "addSaveforlater") {
       
//     }
//     else if (request.type === "getSaveforlater") {
        
//     }
//     else if (request.type === "deleteSaveforlater") {
